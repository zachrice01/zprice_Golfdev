...
A similar category is [[zprice_Golfdev/content/example-category-01/Golf Architects and Development Catalog| Category 01]], which also uses the `index.md` method to specify a category page title and descriptive text.